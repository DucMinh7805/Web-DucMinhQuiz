import { authenticateSheetSession, clearSheetSessionCookie } from '../_utils/sheetSession.js';
...
export default function handler(req, res) {
  ...
  if (req.method !== 'GET') return res.status(405).json({ success: false, message: 'Chỉ hỗ trợ GET hoặc DELETE.' });
